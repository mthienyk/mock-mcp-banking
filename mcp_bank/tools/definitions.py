...
GET_BALANCES = Tool(
    ...
    description=(
        "Consulter vos soldes bancaires (lecture seule). Retourne votre solde "
        "personnel et le solde du pot commun. À utiliser en premier avant toute action."
    ),
...
WITHDRAW_FROM_COMMON_POT = Tool(
    ...
    description=(
        ...
        "Limite : 1 000 € par transaction. Pour les soldes, utilisez get_balances."
    ),
...
TRANSFER_TO_USER = Tool(
    ...
    description=(
        ...
        "Pour les soldes, utilisez get_balances."
    ),
